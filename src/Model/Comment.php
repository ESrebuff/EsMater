...
class Comment extends Model {
    ...
    $sql = 'select * FROM esmater_comment' . ' where post_id = :post_id';
    ...
    $sql = 'select * FROM esmater_comment' . ' where id = :id';
    ...
    $sql = 'insert into esmater_comment(date, author, content, post_id, user_id, user_avatar)' . ' values(NOW(), :author, :content, :post_id, :user_id, :user_avatar)';
    ...
    public function updateAvatarComment($user_id, $img){
        $sql = 'UPDATE esmater_comment SET user_avatar = ?' . ' WHERE user_id = ?';
        $req = $this->executeRequest($sql, array($img, $user_id));
        return $req;
    }
    
    public function deleteComment($idComment){
        $sql = 'DELETE FROM esmater_comment' . ' WHERE id = :id';
        $req = $this->executeRequest($sql, array('id' => $idComment));
        return $req;
    }
    
    public function editComment($content, $idComm){
        $sql = 'UPDATE esmater_comment SET content = :content' . ' WHERE id = :id';
